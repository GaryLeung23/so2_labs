 ...
 * Filesystem layout:
 *
 *      SB      			  INODE LIST	  	INODE 0 DATA BLOCK    INODE 1 DATA BLOCK  ...    INODE 32 DATA BLOCK
 *    ^	(1 block)    		 ^ (1 block)       ^ (1 block)  		 ^ (1 block) 				^ (1 block)
 *    | minfs_super_block    | minfs_inode[32] | minfs_dir_entry[]   |							|
 *    +-0   				 +-- 4096          + 					 +							+
 */
